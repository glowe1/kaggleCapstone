        ...
        foreach ($allAppointments as $appointmentData) {
            ...
            if ($resident) {
                Appointment::create([
                    ...
                    'branch_id' => $appointmentData['branch']->id,
                    'appointment_type_id' => $appointmentData['appointment_type']->id,
                    'healthcare_provider_id' => $appointmentData['healthcare_provider']->id ?? null,
                    ...
                    'next_appointment_date' => $appointmentData['next_appointment_date'],
                    'recurrence_pattern' => $appointmentData['recurrence_pattern'],
